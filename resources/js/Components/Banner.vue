...
watchEffect(async () => {
    style.value = page.props.flash?.bannerStyle || page.props.jetstream?.flash?.bannerStyle || 'success';
    message.value = page.props.flash?.banner || page.props.jetstream?.flash?.banner || '';
    show.value = true;
});
</script>
